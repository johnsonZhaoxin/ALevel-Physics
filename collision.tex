...
\begin{tikzpicture}
	\begin{scope}
	\draw [fill = p1!30,draw = p1!50] (1,0) rectangle (2,0.75);
	\draw [-latex,p1!70,thick] (1.5,0.375) -- (0.5,0.375) node[above right,black] {$v_{1i}$};
	\draw [fill = yellow!30,draw = yellow!50] (-2,0) rectangle (-3,0.75);
	\draw [-latex,yellow!70,thick] (-2.5,0.375) -- (-0.5,0.375) node[ above,black] {$v_{2i}$};
	...
	\draw [fill = p1!30,draw = p1!50] (1,0) rectangle (2,0.75);
	\draw [-latex,p1!70,thick] (1.5,0.375) -- (3.5,0.375) node[above right,black] {$v_{1f}$};
	\draw [fill = yellow!30,draw = yellow!50] (-2,0) rectangle (-3,0.75);
